...
export const WaitlistStrip: React.FC<WaitlistStripProps> = ({ 
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-40 ${className}`} style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
          ...
          <div className="flex items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="hidden sm:flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <h4 className="text-white font-bold text-base lg:text-lg drop-shadow-lg tracking-tight leading-tight">Don't Miss Out!</h4>
            ...
            <div className="sm:hidden flex-1 min-w-0">
              <p className="text-white font-bold text-sm leading-tight">Join 500+ SMEs on the waitlist!</p>
            </div>
