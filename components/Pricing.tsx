  ...
  const plans = [
    {
      ...
      discount: t("pricing.starter.discount"),
      savings: null,
    ...
    },
    {
      ...
      originalPrice: t("pricing.professional.originalPrice"),
      discount: t("pricing.professional.discount"),
      savings: t("pricing.professional.savings"),
            ...
            return (
              <motion.div
                ...
                className={`glass-panel-3d rounded-3xl p-8 relative group ${
                  isStarter
                    ? "border-2 border-gold-400/50 shadow-[0_0_50px_rgba(212,175,55,0.2)]"
                    : "border border-white/10"
                }`}
              >
                {/* Badge */}
                <div
                  className={`absolute -top-4 left-1/2 transform -translate-x-1/2 px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${
