                ...
                <div className="space-y-8 pt-6">
                    ...
                    <div>
                        <div className="flex justify-between text-sm font-medium mb-2">
                            ...
                            <span className="text-gold-400 font-bold">RM {commission}</span>
                        </div>
                        <input 
                            type="range" 
                            min="50" 
                ...
                <div className="glass-panel-3d rounded-3xl p-8 border border-white/10 relative text-center">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <div className="bg-white/5 rounded-xl p-4 border border-white/5">
                            ...
                            <div className="text-xl font-bold text-gold-400">RM {bijouCost.toLocaleString()}</div>
                        </div>
                        <div className="bg-white/5 rounded-xl p-4 border border-white/5">
                            <div className="text-xs text-gray-400 mb-1">Potential ROI</div>
                            <div className="text-xl font-bold text-gold-400">+{roi.toLocaleString()}%</div>
                        </div>
                    </div>
